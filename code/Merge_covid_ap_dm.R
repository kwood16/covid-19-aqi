...
covid_deaths <- read_csv(url(urlfile))
...
covid_cases <- read_csv(url(urlfile))
summary(covid_cases)
...
covid_cases$`7/24/20` <- covid_cases$`7/24/20` - covid_cases$`7/23/20`
covid_cases$`7/23/20` <- covid_cases$`7/23/20` - covid_cases$`7/22/20`
covid_cases$`7/22/20` <- covid_cases$`7/22/20` - covid_cases$`7/21/20`
covid_cases$`7/21/20` <- covid_cases$`7/21/20` - covid_cases$`7/20/20`
covid_cases$`7/20/20` <- covid_cases$`7/20/20` - covid_cases$`7/19/20`
covid_cases$`7/19/20` <- covid_cases$`7/19/20` - covid_cases$`7/18/20`
covid_cases$`7/18/20` <- covid_cases$`7/18/20` - covid_cases$`7/17/20`
covid_cases$`7/17/20` <- covid_cases$`7/17/20` - covid_cases$`7/16/20`
covid_cases$`7/16/20` <- covid_cases$`7/16/20` - covid_cases$`7/15/20`
covid_cases$`7/15/20` <- covid_cases$`7/15/20` - covid_cases$`7/14/20`
covid_cases$`7/14/20` <- covid_cases$`7/14/20` - covid_cases$`7/13/20`
covid_cases$`7/13/20` <- covid_cases$`7/13/20` - covid_cases$`7/12/20`
covid_cases$`7/12/20` <- covid_cases$`7/12/20` - covid_cases$`7/11/20`
covid_cases$`7/11/20` <- covid_cases$`7/11/20` - covid_cases$`7/10/20`
covid_cases$`7/10/20` <- covid_cases$`7/10/20` - covid_cases$`7/9/20`
covid_cases$`7/9/20` <- covid_cases$`7/9/20` - covid_cases$`7/9/20`
covid_cases$`7/8/20` <- covid_cases$`7/8/20` - covid_cases$`7/7/20`
covid_cases$`7/7/20` <- covid_cases$`7/7/20` - covid_cases$`7/6/20`
covid_cases$`7/6/20` <- covid_cases$`7/6/20` - covid_cases$`7/5/20`
covid_cases$`7/5/20` <- covid_cases$`7/5/20` - covid_cases$`7/4/20`
covid_cases$`7/4/20` <- covid_cases$`7/4/20` - covid_cases$`7/3/20`
covid_cases$`7/3/20` <- covid_cases$`7/3/20` - covid_cases$`7/2/20`
covid_cases$`7/2/20` <- covid_cases$`7/2/20` - covid_cases$`7/1/20`
covid_cases$`7/1/20` <- covid_cases$`7/1/20` - covid_cases$`6/30/20`
covid_cases$`6/30/20` <- covid_cases$`6/30/20` - covid_cases$`6/29/20`
covid_cases$`6/29/20` <- covid_cases$`6/29/20` - covid_cases$`6/28/20`
covid_cases$`6/28/20` <- covid_cases$`6/28/20` - covid_cases$`6/27/20`
covid_cases$`6/27/20` <- covid_cases$`6/27/20` - covid_cases$`6/26/20`
covid_cases$`6/26/20` <- covid_cases$`6/26/20` - covid_cases$`6/25/20`
covid_cases$`6/25/20` <- covid_cases$`6/25/20` - covid_cases$`6/24/20`
covid_cases$`6/24/20` <- covid_cases$`6/24/20` - covid_cases$`6/23/20`
covid_cases$`6/23/20` <- covid_cases$`6/23/20` - covid_cases$`6/22/20`
covid_cases$`6/22/20` <- covid_cases$`6/22/20` - covid_cases$`6/21/20`
covid_cases$`6/21/20` <- covid_cases$`6/21/20` - covid_cases$`6/20/20`
covid_cases$`6/20/20` <- covid_cases$`6/20/20` - covid_cases$`6/19/20`
covid_cases$`6/19/20` <- covid_cases$`6/19/20` - covid_cases$`6/18/20`
covid_cases$`6/18/20` <- covid_cases$`6/18/20` - covid_cases$`6/17/20`
covid_cases$`6/17/20` <- covid_cases$`6/17/20` - covid_cases$`6/16/20`
covid_cases$`6/16/20` <- covid_cases$`6/16/20` - covid_cases$`6/15/20`
covid_cases$`6/15/20` <- covid_cases$`6/15/20` - covid_cases$`6/14/20`
covid_cases$`6/14/20` <- covid_cases$`6/14/20` - covid_cases$`6/13/20`
covid_cases$`6/13/20` <- covid_cases$`6/13/20` - covid_cases$`6/12/20`
covid_cases$`6/12/20` <- covid_cases$`6/12/20` - covid_cases$`6/11/20`
covid_cases$`6/11/20` <- covid_cases$`6/11/20` - covid_cases$`6/10/20`
covid_cases$`6/10/20` <- covid_cases$`6/10/20` - covid_cases$`6/9/20`
covid_cases$`6/9/20` <- covid_cases$`6/9/20` - covid_cases$`6/8/20`
covid_cases$`6/8/20` <- covid_cases$`6/8/20` - covid_cases$`6/7/20`
covid_cases$`6/7/20` <- covid_cases$`6/7/20` - covid_cases$`6/6/20`
covid_cases$`6/6/20` <- covid_cases$`6/6/20` - covid_cases$`6/5/20`
covid_cases$`6/5/20` <- covid_cases$`6/5/20` - covid_cases$`6/4/20`
covid_cases$`6/4/20` <- covid_cases$`6/4/20` - covid_cases$`6/3/20`
covid_cases$`6/3/20` <- covid_cases$`6/3/20` - covid_cases$`6/2/20`
covid_cases$`6/2/20` <- covid_cases$`6/2/20` - covid_cases$`6/1/20`
covid_cases$`6/1/20` <- covid_cases$`6/1/20` - covid_cases$`5/31/20`
covid_cases$`5/31/20` <- covid_cases$`5/31/20` - covid_cases$`5/30/20`
covid_cases$`5/30/20` <- covid_cases$`5/30/20` - covid_cases$`5/29/20`
covid_cases$`5/29/20` <- covid_cases$`5/29/20` - covid_cases$`5/28/20`
covid_cases$`5/28/20` <- covid_cases$`5/28/20` - covid_cases$`5/27/20`
covid_cases$`5/27/20` <- covid_cases$`5/27/20` - covid_cases$`5/26/20`
covid_cases$`5/26/20` <- covid_cases$`5/26/20` - covid_cases$`5/25/20`
covid_cases$`5/25/20` <- covid_cases$`5/25/20` - covid_cases$`5/24/20`
covid_cases$`5/24/20` <- covid_cases$`5/24/20` - covid_cases$`5/23/20`
covid_cases$`5/23/20` <- covid_cases$`5/23/20` - covid_cases$`5/22/20`
covid_cases$`5/22/20` <- covid_cases$`5/22/20` - covid_cases$`5/21/20`
covid_cases$`5/21/20` <- covid_cases$`5/21/20` - covid_cases$`5/20/20`
covid_cases$`5/20/20` <- covid_cases$`5/20/20` - covid_cases$`5/19/20`
covid_cases$`5/19/20` <- covid_cases$`5/19/20` - covid_cases$`5/18/20`
covid_cases$`5/18/20` <- covid_cases$`5/18/20` - covid_cases$`5/17/20`
covid_cases$`5/17/20` <- covid_cases$`5/17/20` - covid_cases$`5/16/20`
covid_cases$`5/16/20` <- covid_cases$`5/16/20` - covid_cases$`5/15/20`
covid_cases$`5/15/20` <- covid_cases$`5/15/20` - covid_cases$`5/14/20`
covid_cases$`5/14/20` <- covid_cases$`5/14/20` - covid_cases$`5/13/20`
covid_cases$`5/13/20` <- covid_cases$`5/13/20` - covid_cases$`5/12/20`
covid_cases$`5/12/20` <- covid_cases$`5/12/20` - covid_cases$`5/11/20`
covid_cases$`5/11/20` <- covid_cases$`5/11/20` - covid_cases$`5/10/20`
covid_cases$`5/10/20` <- covid_cases$`5/10/20` - covid_cases$`5/9/20`
covid_cases$`5/9/20` <- covid_cases$`5/9/20` - covid_cases$`5/8/20`
covid_cases$`5/8/20` <- covid_cases$`5/8/20` - covid_cases$`5/7/20`
covid_cases$`5/7/20` <- covid_cases$`5/7/20` - covid_cases$`5/6/20`
covid_cases$`5/6/20` <- covid_cases$`5/6/20` - covid_cases$`5/5/20`
covid_cases$`5/5/20` <- covid_cases$`5/5/20` - covid_cases$`5/4/20`
covid_cases$`5/4/20` <- covid_cases$`5/4/20` - covid_cases$`5/3/20`
covid_cases$`5/3/20` <- covid_cases$`5/3/20` - covid_cases$`5/2/20`
covid_cases$`5/2/20` <- covid_cases$`5/2/20` - covid_cases$`5/1/20`
covid_cases$`5/1/20` <- covid_cases$`5/1/20` - covid_cases$`4/30/20`
covid_cases$`4/30/20` <- covid_cases$`4/30/20` - covid_cases$`4/29/20`
covid_cases$`4/29/20` <- covid_cases$`4/29/20` - covid_cases$`4/28/20`
covid_cases$`4/28/20` <- covid_cases$`4/28/20` - covid_cases$`4/27/20`
covid_cases$`4/27/20` <- covid_cases$`4/27/20` - covid_cases$`4/26/20`
covid_cases$`4/26/20` <- covid_cases$`4/26/20` - covid_cases$`4/25/20`
covid_cases$`4/25/20` <- covid_cases$`4/25/20` - covid_cases$`4/24/20`
covid_cases$`4/24/20` <- covid_cases$`4/24/20` - covid_cases$`4/23/20`
covid_cases$`4/23/20` <- covid_cases$`4/23/20` - covid_cases$`4/22/20`
covid_cases$`4/22/20` <- covid_cases$`4/22/20` - covid_cases$`4/21/20`
covid_cases$`4/21/20` <- covid_cases$`4/21/20` - covid_cases$`4/20/20`
covid_cases$`4/20/20` <- covid_cases$`4/20/20` - covid_cases$`4/19/20`
covid_cases$`4/19/20` <- covid_cases$`4/19/20` - covid_cases$`4/18/20`
covid_cases$`4/18/20` <- covid_cases$`4/18/20` - covid_cases$`4/17/20`
covid_cases$`4/17/20` <- covid_cases$`4/17/20` - covid_cases$`4/16/20`
covid_cases$`4/16/20` <- covid_cases$`4/16/20` - covid_cases$`4/15/20`
covid_cases$`4/15/20` <- covid_cases$`4/15/20` - covid_cases$`4/15/20`
covid_cases$`4/14/20` <- covid_cases$`4/14/20` - covid_cases$`4/13/20`
covid_cases$`4/13/20` <- covid_cases$`4/13/20` - covid_cases$`4/12/20`
covid_cases$`4/12/20` <- covid_cases$`4/12/20` - covid_cases$`4/11/20`
covid_cases$`4/11/20` <- covid_cases$`4/11/20` - covid_cases$`4/10/20`
covid_cases$`4/10/20` <- covid_cases$`4/10/20` - covid_cases$`4/9/20`
covid_cases$`4/9/20` <- covid_cases$`4/9/20` - covid_cases$`4/8/20`
covid_cases$`4/8/20` <- covid_cases$`4/8/20` - covid_cases$`4/7/20`
covid_cases$`4/7/20` <- covid_cases$`4/7/20` - covid_cases$`4/6/20`
covid_cases$`4/6/20` <- covid_cases$`4/6/20` - covid_cases$`4/5/20`
covid_cases$`4/5/20` <- covid_cases$`4/5/20` - covid_cases$`4/4/20`
covid_cases$`4/4/20` <- covid_cases$`4/4/20` - covid_cases$`4/3/20`
covid_cases$`4/3/20` <- covid_cases$`4/3/20` - covid_cases$`4/2/20`
covid_cases$`4/2/20` <- covid_cases$`4/2/20` - covid_cases$`4/1/20`
covid_cases$`4/1/20` <- covid_cases$`4/1/20` - covid_cases$`3/31/20`
covid_cases$`3/31/20` <- covid_cases$`3/31/20` - covid_cases$`3/30/20`
covid_cases$`3/30/20` <- covid_cases$`3/30/20` - covid_cases$`3/29/20`
covid_cases$`3/29/20` <- covid_cases$`3/29/20` - covid_cases$`3/28/20`
covid_cases$`3/28/20` <- covid_cases$`3/28/20` - covid_cases$`3/27/20`
covid_cases$`3/27/20` <- covid_cases$`3/27/20` - covid_cases$`3/26/20`
covid_cases$`3/26/20` <- covid_cases$`3/26/20` - covid_cases$`3/25/20`
covid_cases$`3/25/20` <- covid_cases$`3/25/20` - covid_cases$`3/24/20`
covid_cases$`3/24/20` <- covid_cases$`3/24/20` - covid_cases$`3/23/20`
covid_cases$`3/23/20` <- covid_cases$`3/23/20` - covid_cases$`3/22/20`
covid_cases$`3/22/20` <- covid_cases$`3/22/20` - covid_cases$`3/21/20`
covid_cases$`3/21/20` <- covid_cases$`3/21/20` - covid_cases$`3/20/20`
covid_cases$`3/20/20` <- covid_cases$`3/20/20` - covid_cases$`3/19/20`
covid_cases$`3/19/20` <- covid_cases$`3/19/20` - covid_cases$`3/18/20`
covid_cases$`3/18/20` <- covid_cases$`3/18/20` - covid_cases$`3/17/20`
covid_cases$`3/17/20` <- covid_cases$`3/17/20` - covid_cases$`3/16/20`
covid_cases$`3/16/20` <- covid_cases$`3/16/20` - covid_cases$`3/15/20`
covid_cases$`3/15/20` <- covid_cases$`3/15/20` - covid_cases$`3/14/20`
covid_cases$`3/14/20` <- covid_cases$`3/14/20` - covid_cases$`3/13/20`
covid_cases$`3/13/20` <- covid_cases$`3/13/20` - covid_cases$`3/12/20`
covid_cases$`3/12/20` <- covid_cases$`3/12/20` - covid_cases$`3/11/20`
covid_cases$`3/11/20` <- covid_cases$`3/11/20` - covid_cases$`3/10/20`
covid_cases$`3/10/20` <- covid_cases$`3/10/20` - covid_cases$`3/9/20`
covid_cases$`3/9/20` <- covid_cases$`3/9/20` - covid_cases$`3/8/20`
covid_cases$`3/8/20` <- covid_cases$`3/8/20` - covid_cases$`3/7/20`
covid_cases$`3/7/20` <- covid_cases$`3/7/20` - covid_cases$`3/6/20`
covid_cases$`3/6/20` <- covid_cases$`3/6/20` - covid_cases$`3/5/20`
covid_cases$`3/5/20` <- covid_cases$`3/5/20` - covid_cases$`3/4/20`
covid_cases$`3/4/20` <- covid_cases$`3/4/20` - covid_cases$`3/3/20`
covid_cases$`3/3/20` <- covid_cases$`3/3/20` - covid_cases$`3/2/20`
covid_cases$`3/2/20` <- covid_cases$`3/2/20` - covid_cases$`3/1/20`
covid_cases$`3/1/20` <- covid_cases$`3/1/20` - covid_cases$`2/29/20`  
...
summary(covid_cases)
names(covid_cases)[names(covid_cases) == "Admin2"] <- "County.Name"
names(covid_cases)[names(covid_cases) == "Province_State"] <- "State.Name"
names(covid_deaths)[names(covid_deaths) == "Admin2"] <- "County.Name"
names(covid_deaths)[names(covid_deaths) == "Province_State"] <- "State.Name"

covid_cases <- covid_cases[!(covid_cases$State.Name == "Puerto Rico" | 
                               covid_cases$State.Name == "American Samoa" | covid_cases$State.Name == 
                               "Guam" | covid_cases$State.Name == "Virgin Islands" | 
                               covid_cases$State.Name == "Northern Mariana Islands"), ] 
...
covid_cases <- covid_cases[vars]
covid_deaths <- covid_deaths[vars]

## reshape covid dataframes from wide to long
library(data.table)
library(reshape2)
covid_cases_long <- melt(setDT(covid_cases), id.vars = c("State.Name", "County.Name", "FIPS"), 
